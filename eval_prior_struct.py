...
flags.DEFINE_float("prior_struct_branch_path_cost_weight", 0.35, "Penalty weight for longer corridor branches")
flags.DEFINE_float("prior_struct_branch_progress_weight", 1.0, "Weight for branch-conditioned goal progress")
flags.DEFINE_float("prior_struct_branch_goal_weight", 1.0, "Weight for branch-conditioned goal closeness")
flags.DEFINE_float("prior_struct_final_critic_weight", 1.0, "Weight for critic during final candidate rerank")
flags.DEFINE_float("prior_struct_final_progress_weight", 0.75, "Weight for goal progress during final candidate rerank")
flags.DEFINE_float("prior_struct_final_length_weight", 0.25, "Penalty weight for path length during final candidate rerank")
flags.DEFINE_float("prior_struct_final_goal_weight", 0.5, "Weight for final goal closeness during final candidate rerank")
